#include <bits/stdc++.h>
#include "../Template/DSURollback.cpp"
...
void solve() {
    ...
    rollback();
    assert(sz[getpar(3)] == 3 && "Size correct after rollback");

    rollback();
    assert(sz[getpar(3)] == 1 && "Size correct after rollback");
    assert(sz[getpar(1)] == 2 && "Size correct after rollback");

    rollback();
    assert(sz[getpar(1)] == 1 && "Size correct after rollback");
